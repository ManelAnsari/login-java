...
public class Page1 extends JFrame implements ActionListener 
{
	...
	public Page1() {
		...
		//setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);// fermeture de programme si on clique sur x
	 ...
	 @Override
	  public void actionPerformed(ActionEvent ae)// generer source boutoun
	  {
		  ...
		  if(bb==b2)                     //Login
		  {
             ...
             try
             {
              Class.forName("com.mysql.jdbc.Driver");
           	  Connection cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/logintp", "root", "");
           	  ...
           	  cn.close();//pour terminer chaques session de basede données. 
           	  st.close();//close requete
		     }
